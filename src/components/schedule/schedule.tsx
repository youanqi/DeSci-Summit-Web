            ...
            <div className="bg-[#132990] p-5">
              ...
              <div className="mt-28">
                ...
                <p className="font-syne font-[400] text-[18px] text-[#54FF7A]">
                  ...
                  Taylor Hulsman <span className="text-white"> </span><br />
   ...
   <div className="bg-[#132990] p-5">
    ...
    <div className="bg-[#132990] p-5">
     ...
     <div className="bg-[#132990] p-5">
              ...
              <p className="font-syne font-[500] text-[40px] text-white">
                DeSci Visioning Session: Embracing the Future{" "}
              </p>
              <div className="mt-28">
                <p className="font-syne font-[400] text-[24px] text-white">
                  Speakers
                ...
                <p className="font-syne font-[400] text-[18px] text-[#54FF7A]">
                  Danette Wallace  <span className="text-white">Conexuns</span><br />
                  Jelani Clarke, Ph.D.  <span className="text-white">DeSciWorld</span><br />
